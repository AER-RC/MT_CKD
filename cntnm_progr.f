...
c
      ...
      print *, 'Pressure (mb), Temperature (K), Path Length (cm)'
      print *, pave,tave,xlength
C
c     It may be preferable to specifiy the water column directly!
c
      VMRH2O = 0.01
C
      WTOT = XLOSMT*(PAVE/1013.)*(273./TAVE)*1.E+05 * xlength
C
      WW = WTOT / (1.+VMRH2O)
c
...
C
  ...
  920 FORMAT(//,' self and foreign water vapor continuum coefficients ',/,
     x       'for  ',f8.2,'K - ',   //,
     x       ' the self-continuum scales as ( Rh2o/Ro ) ',/,
     x       ' the foreign continuum scales as ( (Rtot-Rh2o)/Ro ) ',/,
